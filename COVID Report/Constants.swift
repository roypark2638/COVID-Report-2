...
struct K {
    ...
    static let states = [
        "United State","Alabama","Alaska","American Samoa","Arizona","Arkansas",
    ...
    static let stateAbbreviations = [
        "United State","AL","AK","AS","AZ","AR","CA","CO","CT","DE","DC","FM",
